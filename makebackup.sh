...
sudo rsync -qapXv --delete --delete-during --inplace  --exclude={"/dev/*","/proc/*","/sys/*","/tmp/*","/run/*","/mnt/*","/media/*","/lost+found","/home/*/.cache/*","/home/*/Downloads/*","/home/*/tmp/*","/backupstore","/home/*/.claws-mail/imapcache/*","/var/cache/pacman/pkg/*","/var/log/journal/*"} /* /backupstore/root/
